...
public final class AwarenessService {
    ...
    private List<VideoItem> videos() {
        return List.of(
                new VideoItem("Authentic Guide to Aadhaar-DBT Seeding", "The essential official walkthrough explaining the difference between simple linking and NPCI mapper seeding for Direct Benefit Transfer.", "UIDAI / Official Awareness", "https://www.youtube.com/watch?v=t2RfIMizWwc", "t2RfIMizWwc"),
                new VideoItem("mAadhaar: Complete Digital Ecosystem", "A professional overview of the mAadhaar application and its role in resident identity management and service accessibility.", "UIDAI / Service Guide", "https://www.youtube.com/watch?v=z5Hl0UlqBKk", "z5Hl0UlqBKk"),
                new VideoItem("Security Protocol: Masked Aadhaar", "Learn the official security recommendations for using Masked Aadhaar to protect your privacy while ensuring identity verification.", "UIDAI / Data Security", "https://www.youtube.com/watch?v=jNaqPc8-eeA", "jNaqPc8-eeA"),
                new VideoItem("Resident Service: Video KYC Explained", "A detailed guide on how Video KYC simplifies the account opening and Aadhaar verification process for modern banking.", "UIDAI / Technical Series", "https://www.youtube.com/watch?v=H02T5q0h_fA", "H02T5q0h_fA"),
                new VideoItem("Online Appointment Management", "How to use the official booking system to avoid queues and ensure efficient Aadhaar updates at authorized centers.", "UIDAI / Resident Support", "https://www.youtube.com/watch?v=8ZurY3nrv7U", "8ZurY3nrv7U"),
                new VideoItem("Digital Verification at Public Events", "Demonstrating the power of digital Aadhaar verification for secure and seamless entry at large-scale venues.", "UIDAI / Awareness Series", "https://www.youtube.com/watch?v=yHwra5eVAW8", "yHwra5eVAW8"),
                new VideoItem("Secure Contact Sharing", "An explainer on the secure mechanisms for sharing contact details using the Aadhaar ecosystem without compromising sensitive data.", "UIDAI / Privacy Series", "https://www.youtube.com/watch?v=UsQ_68qBi-4", "UsQ_68qBi-4"),
                new VideoItem("Biometric Locking & Security", "Prevent unauthorized authentication by locking your biometrics via the official portal or mAadhaar app. A critical security step for all residents.", "UIDAI / Security Guide", "https://www.youtube.com/watch?v=O4z16E7L_t4", "O4z16E7L_t4"),
                new VideoItem("Order Aadhaar PVC Card Online", "The authentic procedure for ordering a durable, weather-proof PVC Aadhaar card with advanced security features directly to your home.", "UIDAI / Resident Service", "https://www.youtube.com/watch?v=_oWJmX-R3p8", "_oWJmX-R3p8"),
                new VideoItem("Official Address Update Workflow", "A step-by-step tutorial on updating your residential address using valid supporting documents through the MyAadhaar portal.", "UIDAI / Update Guide", "https://www.youtube.com/watch?v=bK8A1Zk8m6k", "bK8A1Zk8m6k"),
                new VideoItem("Understanding Offline e-KYC", "How to use paperless offline e-KYC to share your identity securely without providing your physical Aadhaar card or biometric data.", "UIDAI / Technical Series", "https://www.youtube.com/watch?v=fBBQycZ7UhI", "fBBQycZ7UhI"),
                new VideoItem("Virtual ID (VID) Generation", "Learn how to generate and use a 16-digit Virtual ID as a temporary alternative to your Aadhaar number for enhanced privacy.", "UIDAI / Privacy Guide", "https://www.youtube.com/watch?v=68qBi-4UsQ", "68qBi-4UsQ"),
                new VideoItem("Authentication History Tracking", "Monitor who has accessed your Aadhaar data and for what purpose by checking your official authentication history log.", "UIDAI / Security Awareness", "https://www.youtube.com/watch?v=yHwra5eVAW8", "yHwra5eVAW8"),
                new VideoItem("Official Awareness Channel Intro", "The primary introduction to the national awareness initiative for Aadhaar-based digital empowerment.", "UIDAI / Governance", "https://www.youtube.com/watch?v=_JSMjK8wv40", "_JSMjK8wv40"),
                new VideoItem("UIDAI Aadhaar App Portal", "The central digital hub for all official Aadhaar application tutorials and awareness material.", "UIDAI", "https://uidai.gov.in/en/my-aadhaar/aadhaar-on-your-mobile/aadhaar-app-videos.html", ""),
                new VideoItem("DBT Bharat Multimedia Archives", "A comprehensive repository of government multimedia content covering all aspects of the Direct Benefit Transfer mission.", "DBT Bharat", "https://dbtbharat.gov.in/multimedia/video", ""));
    }
